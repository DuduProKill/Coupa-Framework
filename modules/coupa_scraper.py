...
class AutomationWorker(QThread):
    ...
    def run(self):
        ...
        # Wrap log_callback para emitir progresso
        total = len(self.requisicoes)
        contador = [0]  # mutable para closure
        ...
        results = loop.run_until_complete(scraper.run(log_with_progress, self.edge_ready_signal.emit))
